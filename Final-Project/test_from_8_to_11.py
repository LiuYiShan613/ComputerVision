# -*- coding: utf-8 -*-
"""
Created on Sat Jan  1 16:56:39 2022
...
def alignImages(input_img, ref_img, i, MAX_FEATURES = 5000, GOOD_MATCH_PERCENT = 0.03):
    ...
    input_img_Reg = cv2.cvtColor(input_img_Reg, cv2.COLOR_BGR2GRAY)
    input_img_Reg = cv2.resize(input_img_Reg, (width*3, height*3))
    
    input_img_Reg = cv2.threshold(input_img_Reg, 128, 255, cv2.THRESH_BINARY)[1]
    input_img_Reg = cv2.resize(input_img_Reg, (width, height))
